...
When it comes to naming variables, types, classes, etc. and the position of imports, we adhere to the conventions of the [PEP 8 - Style Guide for Python Code](https://peps.python.org/pep-0008/#naming-conventions).
...
Python should be commented in the [DocBlockr style](https://github.com/NilsJPWerner/autoDocstring/blob/master/docs/docblockr.md). We suggest using the recommended extensions where [autoDocstring](https://github.com/NilsJPWerner/autoDocstring) is included, which allows you to generate a template comment based on the function signature.

## TypeScript Style Guide

### Formatting

We format our code using [prettier](https://prettier.io/docs/). See our [package.json](package.json) for our settings and refer to the prettier docs for getting information about the enforced style guide.
