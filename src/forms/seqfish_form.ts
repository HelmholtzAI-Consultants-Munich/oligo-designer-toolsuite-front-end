const formDatas = {
    ...
    dir_output: {
        value: "output_seqfishplus_probe_designer",
    ...
    files_fasta_target_probe_database: {
        value: "",
        comment:
            "fasta file with sequences form which the probes should be generated. Hint: use the genomic_region_generator pipeline to create fasta files of genomic regions of interest",
    },
    files_fasta_reference_database_target_probe: {
        value: "",
        comment:
            "fasta file with sequences used as reference for the specificity filters. Hint: use the genomic_region_generator pipeline to create fasta files of genomic regions of interest",
    },
    target_probe_length_min: { value: "28", comment: "min length of probe" },
    target_probe_length_max: { value: "28", comment: "max length of probe" },
    target_probe_isoform_consensus: {
        value: "100",
        comment:
            "min isoform consesnsus for probes, i.e. how many transcripts of the total number of transcripts of a gene are covered by the probe, given in %",
    },
    target_probe_GC_content_min: {
        value: "45",
        comment: "minimum GC content of oligos",
    },
    target_probe_GC_content_opt: {
        value: "55",
        comment: "max and min values are defiend above",
    },
    target_probe_GC_content_max: {
        value: "65",
        comment: "maximum GC content of oligos",
    },
    ...
    target_probe_T_secondary_structure: {
        value: "76",
        comment: "Temperature at which the free energy is calculated",
    },
    target_probe_secondary_structures_threshold_deltaG: {
        value: "0",
        comment:
            "threshold for the secondary structure free energy -> oligo rejected if it presents a structure with a negative free energy at the defined temperature",
    },
    target_probe_GC_weight: {
        value: "1",
        comment:
            "weight of the GC content of the probe in the efficiency score",
    },
    target_probe_UTR_weight: {
        value: "10",
        comment: "weight of the Tm of the probe in the efficiency score",
    },
    set_size_min: {
        value: "24",
        comment:
            "minimum size of probe sets (in case there exist no set of the optimal size) -> genes with less oligos will be filtered out and stored in regions_with_insufficient_oligos_for_db_probes",
    },
    set_size_opt: { value: "24", comment: "optimal size of probe sets" },
    distance_between_target_probes: {
        value: "2",
        comment:
            "how much overlap should be allowed between oligos, e.g. if oligos can overlpap x bases choose -x, if oligos can be next to one another choose 0, if oligos should be x bases apart choose x",
    },
    ...
    readout_probe_length: { value: "15", comment: "length of readout probes" },
    ...
    n_barcode_rounds: { value: "4", comment: "number of barcoding rounds" },
    n_pseudocolors: { value: "20", comment: "number of pseudocolors" },
    channels_ids: {
        value: ["Alexa488, Cy3b, Alexa647"],
        comment: "names of fluorescent channels",
    },
    ...
    reverse_primer_sequence: {
        value: "CCCTATAGTGAGTCGTATTA",
        comment:
            "defaults to reverse complement of 20 nt T7 promoter sequence, change if different sequence desired",
    },
    ...
    primer_number_GC_GCclamp: {
        value: "1",
        comment:
            "the minimum number of G or C nucleotides required within the specified number of bases",
    },
    primer_number_three_prime_base_GCclamp: {
        value: "2",
        comment:
            "the number of bases to consider from the 3' end of the sequence",
    },
    ...
    target_probe_specificity_blastn_search_parameters: {
        ...
        strand: {
            value: "minus",
            comment:
                'this parameter is fixed, if reference is whole genome, consider using "both"',
        },
    ...
    target_probe_specificity_blastn_hit_parameters: {
        min_alignment_length: {
            value: "15",
            comment: "can be turned into coverage",
        },
    },
    ...
    n_attempts: {
        value: "100000",
        comment: "number of attempts to find the optimal set of oligos",
    },
    heuristic: {
        value: "true",
        comment:
            "apply heuristic pre-search to reduce search space and runtime of oligo set selection",
    },
    heuristic_n_attempts: {
        value: "100",
        comment:
            "number of attempts to find the optimal set of oligos for heuristic pre-search",
    },
    readout_probe_initial_num_sequences: {
        value: "100000",
        comment:
            "if not enough readout probes can be generated, increase this number",
    },
    ...
    primer_initial_num_sequences: {
        value: "1000000",
        comment: "if no primer can be generated, increase this number",
    },
    ...
    primer_Tm_parameters: {
        nn_table: {
            value: "DNA_NN4",
            comment: "S antaLucia (2004) taken from Moffitt (2016)",
        },
        ...
        dnac1: {
            value: "250",
            comment:
                "[nM] taken from https://github.com/ZhuangLab/MERFISH_analysis",
        },
        dnac2: {
            value: "250",
            comment:
        ...
        saltcorr: {
            value: "5",
            comment:
                "correction for deltaS, taken from https://github.com/ZhuangLab/MERFISH_analysis",
        },
        Na: {
            value: "300",
            comment:
                "[mM] 0.3M, taken from https://github.com/ZhuangLab/MERFISH_analysis",
        },
    ...
    primer_Tm_chem_correction_parameters: {
        value: "None",
        comment: "if chem correction desired, please add parameters below",
    },
    primer_Tm_salt_correction_parameters: {
        value: "None",
        comment: "if salt correction desired, please add parameters below",
    },
};
