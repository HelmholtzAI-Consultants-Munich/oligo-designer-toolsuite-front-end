const formDatas = {
    ...
    dir_output: {
        value: "output_merfish_probe_designer",
    ...
    target_probe_Tm_min: {
        value: "66",
        comment: "minimum melting temperature of oligos",
    },
    target_probe_Tm_opt: {
        value: "72",
        comment: "max and min values are defiend above",
    ...
    target_probe_Tm_max: {
        value: "76",
        comment: "maximum melting temperature of oligos",
    },
    ...
    readout_probe_set_size: {
        value: "16",
        comment: "total number of readout probes",
    },
    ...
    n_bits: {
        value: "16",
        comment: "number of bits contained in each barcode",
    },
    min_hamming_dist: {
        value: "4",
        comment: "minimum distance between two valid barcodes",
    },
    hamming_weight: {
        value: "4",
        comment: "number of bits containing one in each barcode",
    },
    channels_ids: {
    ...
    readout_probe_Tm_chem_correction_parameters: {
        value: "None",
        comment: "if chem correction desired, please add parameters below",
    },
    readout_probe_Tm_salt_correction_parameters: {
        value: "None",
        comment: "if salt correction desired, please add parameters below",
    },
    readout_probe_n_combinations: {
        value: "100000",
        comment:
            "number of random combinations of readout probe sets to iteratte through",
    },
