                ...
                return (
                    <div className="mb-3">
                                ...
                                <div className="d-flex align-items-center w-100 gap-2">
                                    ...
                                    <input
                                        ...
                                        disabled={
                                            ...
                                            runStatus === "running" ||
                                            formData.file_regions.value.length >
                                                0
                                        }
                                    />
                                    <div className="w-50">
                        ...
                        <div className="row g-3">
                            <div className="col">
                                <label
                                    htmlFor="probe_length_min.value"
                                    className="form-label"
                                >
                                    Min Probe Length:
                                </label>
                            ...
                            <div className="col">
                                ...
                                <div className="d-flex align-items-center">
                                    <input
                                        ...
                                        value={
                                            formData.target_probe_Tm_min.value
                                        }
                                        onChange={handleChange}
                                        required
                                    />
                            ...
                            <div className="col">
                                ...
                                <div className="d-flex align-items-center">
                                    <input
                                        ...
                                        value={
                                            formData.target_probe_Tm_max.value
                                        }
                                        onChange={handleChange}
                                        required
                                    />
                ...
                return (
                    <div>
                        <div className="row g-3">
                            ...
                            <div className="col">
                                <label
                                    htmlFor="detect_oligo_length_min"
                                    className="form-label"
                                >
                                    Min Length (bp):
                                </label>
                                <div className="d-flex align-items-center">
                                    <input
                                        ...
                                        value={
                                            formData.detection_oligo_length_min
                                                .value
                                        }
                                        onChange={handleChange}
                                        required
                            ...
                            <div className="col">
                                <label
                                    htmlFor="detect_oligo_length_max"
                                    className="form-label"
                                >
                                    Max Length (bp):
                                </label>
                                <div className="d-flex align-items-center">
                                    <input
                                        ...
                                        value={
                                            formData.detection_oligo_length_max
                                                .value
                                        }
                                        onChange={handleChange}
                                        required
                            ...
                            <div className="col">
                                ...
                                <div className="d-flex align-items-center">
                                    <input
                                        ...
                                        value={
                                            formData.detection_oligo_U_distance
                                                .value
                                        }
                                        onChange={handleChange}
                                        required
                            ...
                            <div className="col">
                                ...
                                <div className="d-flex align-items-center">
                                    <input
                                        ...
                                        value={
                                            formData.detection_oligo_Tm_opt
                                                .value
                                        }
                                        onChange={handleChange}
                                        required
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="d-flex align-items-center">
                                    <input
                                        ...
                                        value={
                                            formData.target_probe_Tm_parameters
                                                .nn_table.value
                                        }
                                        onChange={handleChange}
                                    />
                    ...
                    <div>
                        <div className="mb-4">
                            ...
                            <div className="mb-4">
                                <div className="d-flex align-items-center">
                                    <h5>
                                        Chemical Correction Parameters for
                                        Detection Oligo
                                    </h5>
                                </div>
                                <div className="row g-3">
                        ...
                        <Collapse in={expanded}>
                            <div className="text-center mt-2">
                                <p className="text-muted">
                                    Padlock probes are short single-stranded
                                    oligos designed to bind a target sequence at
                                    both their 5′ and 3′ ends. Once hybridized,
                                    the probe’s ends are ligated to form a
                                    circular molecule that can then be amplified
                                    or visualized in situ. Scrinshot
                                    (Single-Cell RNA In-Situ Hybridization and
                                    Sequencing On Tissue) uses these padlock
                                    probes to detect and quantify specific RNA
                                    transcripts at single-cell resolution,
                                    enabling highly multiplexed and spatially
                                    resolved gene expression analysis. Padlock
                                    probes contain two variable gene-specific
                                    5’- and 3’- arms and a stable backbone
                                    sequence of 53 nucleotides (nt) which is
                                    subdivided in four parts. Circularized
                                    padlock probe is hybridized to the
                                    complementary sequence of the corresponding
                                    mRNA
                                </p>
                                <img
                                    src={scrinshotImage}
