        ...
        return (
          <div className="mb-3">
                ...
                <OverlayTrigger
                  ...
                  overlay={
                    <Popover id="top_n_sets">
                      <Popover.Body>{formData.top_n_sets.comment}</Popover.Body>
                    </Popover>
                  }
                >
                  <InfoCircle
            ...
            <div className="row g-3">
              <div className="col">
                <label htmlFor="probe_length_min.value" className="form-label">
                  Min Probe Length:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_length_min.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                <label htmlFor="probe_length_max" className="form-label">
                  Max Probe Length:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_length_max.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                <label htmlFor="probe_isoform_consensus" className="form-label">
                  Isoform Consensus (%):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_isoform_consensus.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
            ...
            <div className="row g-3">
              <div className="col">
                <label htmlFor="probe_GC_content_min" className="form-label">
                  Min GC Content (%):
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="probe_GC_content_opt" className="form-label">
                  Optimal GC Content (%):
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="probe_GC_content_max" className="form-label">
                  Max GC Content (%):
                </label>
                <div className="d-flex align-items-center">
                  <input
            ...
            <div className="row g-3">
              <div className="col">
                <label htmlFor="probe_Tm_min" className="form-label">
                  Min Tm (°C):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_Tm_min.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                <label htmlFor="probe_Tm_max" className="form-label">
                  Max Tm (°C):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_Tm_max.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                <label htmlFor="probe_Tm_opt" className="form-label">
                  Opt Tm (°C):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_Tm_opt.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
            ...
            <h6 className="pt-2">Homopolymeric run per base </h6>
            <div className="row g-3">
              <div className="col">
                <label htmlFor="homopolymeric_A" className="form-label">
                  A:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="homopolymeric_T" className="form-label">
                  T:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="homopolymeric_C" className="form-label">
                  C:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="homopolymeric_G" className="form-label">
                  G:
                </label>
                <div className="d-flex align-items-center">
                  <input
            ...
            <div className="mb-3">
              <label htmlFor="arm_Tm_dif_max" className="form-label">
                Max Tm Difference Between Arms:
              </label>
              <div className="d-flex align-items-center">
                <input
                  type="number"
            ...
            <div className="row g-3">
              <div className="col">
                <label htmlFor="arm_length_min" className="form-label">
                  Min Arm Length:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="arm_Tm_min" className="form-label">
                  Min Arm Tm:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    className="form-control"
                    id="arm_Tm_min"
                    name="target_probe_padlock_arm_Tm_min"
              ...
              <div className="col">
                <label htmlFor="arm_Tm_max" className="form-label">
                  Max Arm Tm:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    className="form-control"
                    id="arm_Tm_max"
                    name="target_probe_padlock_arm_Tm_max"
            ...
            <div className="mb-3">
              <label htmlFor="ligation_region_size" className="form-label">
                Litigation Region Size:
              </label>
              <div className="d-flex align-items-center">
                <input
                  type="number"
                  className="form-control"
                  id="target_probe_ligation_region_size"
                  name="target_probe_ligation_region_size"
                  value={formData.target_probe_ligation_region_size.value}
                  onChange={handleChange}
                />
                <OverlayTrigger
                  trigger="hover"
            ...
            <div className="row g-3">
              <div className="col">
                <label htmlFor="probe_isoform_weight" className="form-label">
              ...
              <label htmlFor="probe_GC_weight" className="form-label">
                GC Content Weight:
              </label>
              <div className="d-flex align-items-center">
                <input
                  ...
                  value={formData.target_probe_GC_weight.value}
                  onChange={handleChange}
                  required
                />
                <OverlayTrigger
              ...
              <div className="col">
                <label htmlFor="probe_Tm_weight" className="form-label">
                  Tm Weight:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_Tm_weight.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="row g-3">
                <div className="col">
                  <label htmlFor="probeset_size_min" className="form-label">
                ...
                <div className="col">
                  <label htmlFor="probeset_size_opt" className="form-label">
                ...
                <div className="col">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-n_jobs">
                          <Popover.Body>{formData.n_sets.comment}</Popover.Body>
                        </Popover>
                      }
                    >
                      <InfoCircle
      ...
      case "detection_oligos":
        return (
          <div>
            <div className="row g-3">
              <div className="col">
                <label htmlFor="min_thymines" className="form-label">
                  Min Thymines:
                </label>
              ...
              <div className="col">
                <label htmlFor="detect_oligo_length_min" className="form-label">
                  Min Length (bp):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="detection_oligo_length_min"
                    name="detection_oligo_length_min"
                    value={formData.detection_oligo_length_min.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                <label htmlFor="detect_oligo_length_max" className="form-label">
                  Max Length (bp):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="detection_oligo_length_max"
                    name="detection_oligo_length_max"
                    value={formData.detection_oligo_length_max.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
            ...
            <div className="row g-3">
              <div className="col">
                <label
                  htmlFor="detection_oligo_U_distance"
                  className="form-label"
                >
                  Preferred U Distance:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="detection_oligo_U_distance"
                    name="detection_oligo_U_distance"
                    value={formData.detection_oligo_U_distance.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                <label htmlFor="detect_oligo_Tm_opt" className="form-label">
                  Optimal Detection Oligo Tm (°C):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="detection_oligo_Tm_opt"
                    name="detection_oligo_Tm_opt"
                    value={formData.detection_oligo_Tm_opt.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
        ...
        return (
          <div>
            <div className="row g-3">
              <div className="col-md-6">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={
                      formData.target_probe_specificity_blastn_search_parameters
                        .perc_identity.value
                    }
                    onChange={handleChange}
                    required
              ...
              <div className="col-md-6">
                <label htmlFor="specificity_strand" className="form-label">
                  Strand
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="specificity_word_size" className="form-label">
                  Word Size:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="specificity_dust" className="form-label">
                  Dust:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="specificity_max_hsps" className="form-label">
                  Max HSPs:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="specificity_coverage" className="form-label">
        ...
        return (
          <div>
            <div className="row g-3">
              ...
              <div className="col-md-6">
                <label htmlFor="crosshybridization_dust" className="form-label">
                  Dust:
                </label>
                <div className="d-flex align-items-center">
                  <input
      ...
      case "oligosetselection":
        return (
          <div>
            <div className="row g-3">
              <div className="col-md-6">
                <label htmlFor="max_graph_size" className="form-label">
                  Max Graph Size:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="n_attempts" className="form-label">
                  Number of Attempts:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="heuristic_n_attempts" className="form-label">
                  {" "}
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.heuristic_n_attempts.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
      ...
      case "meltingtemp":
        return (
          <div>
            <div className="row g-3">
              <div className="col-md-6">
                <label htmlFor="Tm_probe_nn_table" className="form-label">
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_tmm_table" className="form-label">
                  TMM Table:
                </label>
                <div className="d-flex align-items-center">
                  <input
                  ...
                  <OverlayTrigger
                    ...
                    overlay={
                      <Popover id="popover-tmm-table">
                        <Popover.Body>
                          {
                            formData.target_probe_Tm_parameters.tmm_table
                              .comment
                          }
                        </Popover.Body>
                      </Popover>
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_imm_table" className="form-label">
                  IMM Table:
                </label>
                <div className="d-flex align-items-center">
                  <input
                  ...
                  <OverlayTrigger
                    ...
                    overlay={
                      <Popover id="popover-imm-table">
                        <Popover.Body>
                          {
                            formData.target_probe_Tm_parameters.imm_table
                              .comment
                          }
                        </Popover.Body>
                      </Popover>
              ...
              <div className="col-md-6">
                <label htmlFor="DE_probe_imm_table" className="form-label">
                  DE Table:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_dnac1" className="form-label">
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_dnac2" className="form-label">
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_saltcorr" className="form-label">
                  Salt Correction:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_Na" className="form-label">
                  Na Concentration (mM):
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_K" className="form-label">
                  K Concentration (mM):
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_Tris" className="form-label">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_Tm_parameters.Tris.value}
                    onChange={handleChange}
                  />
                  <OverlayTrigger
                    trigger="hover"
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_Mg" className="form-label">
                  Mg Concentration (mM):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_Tm_parameters.Mg.value}
                    onChange={handleChange}
                  />
                  <OverlayTrigger
                    trigger="hover"
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_dNTPs" className="form-label">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.target_probe_Tm_parameters.dNTPs.value}
                    onChange={handleChange}
                  />
                  <OverlayTrigger
                    trigger="hover"
            ...
            <div className="row g-3">
              <div className="col-md-6">
                <label htmlFor="Tm_probe_DMSO" className="form-label">
                  DMSO (%):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="target_probe_Tm_chem_correction_parameters.DMSO"
                    name="target_probe_Tm_chem_correction_parameters.DMSO"
                    value={
                      formData.target_probe_Tm_chem_correction_parameters.DMSO
                        .value
                    }
                    onChange={handleChange}
                  />
                  <OverlayTrigger
                    ...
                    overlay={
                      <Popover id="popover-dmso">
                        <Popover.Body>
                          {
                            formData.target_probe_Tm_chem_correction_parameters
                              .DMSO.comment
                          }
                        </Popover.Body>
                      </Popover>
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_fmd" className="form-label">
                  Formamide (fmd, %):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="target_probe_Tm_chem_correction_parameters.fmd"
                    name="target_probe_Tm_chem_correction_parameters.fmd"
                    value={
                      formData.target_probe_Tm_chem_correction_parameters.fmd
                        .value
                    }
                    onChange={handleChange}
                  />
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_DMSOfactor" className="form-label">
                  DMSO Factor:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="target_probe_Tm_chem_correction_parameters.DMSOfactor"
                    name="target_probe_Tm_chem_correction_parameters.DMSOfactor"
                    value={
                      formData.target_probe_Tm_chem_correction_parameters
                        .DMSOfactor.value
                    }
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_fmdfactor" className="form-label">
                  Formamide Factor:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="target_probe_Tm_chem_correction_parameters.fmdfactor"
                    name="target_probe_Tm_chem_correction_parameters.fmdfactor"
                    value={
                      formData.target_probe_Tm_chem_correction_parameters
                        .fmdfactor.value
                    }
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_fmdmethod" className="form-label">
                  Formamide Method:
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="number"
                    className="form-control"
                    id="target_probe_Tm_chem_correction_parameters.fmdmethod"
                    name="target_probe_Tm_chem_correction_parameters.fmdmethod"
                    value={
                      formData.target_probe_Tm_chem_correction_parameters
                        .fmdmethod.value
                    }
              ...
              <div className="col-md-6">
                <label htmlFor="Tm_probe_GC" className="form-label">
                  GC (optional):
                </label>
                <div className="d-flex align-items-center">
                  <input
                    type="text"
                    className="form-control"
                    id="target_probe_Tm_chem_correction_parameters.GC"
                    name="target_probe_Tm_chem_correction_parameters.GC"
                    value={
                      formData.target_probe_Tm_chem_correction_parameters.GC
                        .value
                    }
                    onChange={handleChange}
                    placeholder="null"
        ...
        return (
          <div>
            <div className="mb-4">
              <div className="row g-3">
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_nn_table" className="form-label">
                    Nearest Neighbor Table:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="text"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.nn_table"
                      name="detection_oligo_Tm_parameters.nn_table"
                      value={
                        formData.detection_oligo_Tm_parameters.nn_table.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-nn-table-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.nn_table
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      type="text"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.tmm_table"
                      name="detection_oligo_Tm_parameters.tmm_table"
                      value={
                        formData.detection_oligo_Tm_parameters.tmm_table.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-tmm-table-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.tmm_table
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      type="text"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.imm_table"
                      name="detection_oligo_Tm_parameters.imm_table"
                      value={
                        formData.detection_oligo_Tm_parameters.imm_table.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-imm-table-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.imm_table
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_de_table" className="form-label">
                    DE Table:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="text"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.de_table"
                      name="detection_oligo_Tm_parameters.de_table"
                      value={
                        formData.detection_oligo_Tm_parameters.de_table.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-de-table-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.de_table
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_dnac1" className="form-label">
                    DNA Concentration 1 (nM):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.dnac1"
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-dnac1-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.dnac1
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_dnac2" className="form-label">
                    DNA Concentration 2 (nM):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.dnac2"
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-dnac2-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.dnac2
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_saltcorr" className="form-label">
                    Salt Correction:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.saltcorr"
                      name="detection_oligo_Tm_parameters.saltcorr"
                      value={
                        formData.detection_oligo_Tm_parameters.saltcorr.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-saltcorr-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.saltcorr
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_Na" className="form-label">
                    Na Concentration (mM):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.Na"
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_K" className="form-label">
                    K Concentration (mM):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.K"
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_Tris" className="form-label">
                    Tris Concentration (mM):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.Tris"
                      name="detection_oligo_Tm_parameters.Tris"
                      value={formData.detection_oligo_Tm_parameters.Tris.value}
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      trigger="hover"
                      ...
                      overlay={
                        <Popover id="popover-tris-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.Tris
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_Mg" className="form-label">
                    Mg Concentration (mM):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.Mg"
                      name="detection_oligo_Tm_parameters.Mg"
                      value={formData.detection_oligo_Tm_parameters.Mg.value}
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      trigger="hover"
                ...
                <div className="col-md-6">
                  <label htmlFor="Tm_detection_dNTPs" className="form-label">
                    dNTPs Concentration (mM):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                      type="number"
                      className="form-control"
                      id="detection_oligo_Tm_parameters.dNTPs"
                      name="detection_oligo_Tm_parameters.dNTPs"
                      value={formData.detection_oligo_Tm_parameters.dNTPs.value}
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      trigger="hover"
                      ...
                      overlay={
                        <Popover id="popover-dntps-detection">
                          <Popover.Body>
                            {
                              formData.detection_oligo_Tm_parameters.dNTPs
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
              ...
              <div className="mb-4">
                ...
                <div className="row g-3">
                  <div className="col-md-6">
                    <label htmlFor="Tm_detection_DMSO" className="form-label">
                      DMSO (%):
                    </label>
                    <div className="d-flex align-items-center">
                      <input
                        type="number"
                        className="form-control"
                        id="detection_oligo_Tm_chem_correction_parameters.DMSO"
                        name="detection_oligo_Tm_chem_correction_parameters.DMSO"
                        value={
                          formData.detection_oligo_Tm_chem_correction_parameters
                            .DMSO.value
                        }
                        onChange={handleChange}
                      />
                  ...
                  <div className="col-md-6">
                    <label htmlFor="Tm_detection_fmd" className="form-label">
                      Formamide (fmd, %):
                    </label>
                    <div className="d-flex align-items-center">
                      <input
                        type="number"
                        className="form-control"
                        id="detection_oligo_Tm_chem_correction_parameters.fmd"
                  ...
                  <div className="col-md-6">
                    <label
                      htmlFor="Tm_detection_DMSOfactor"
                      className="form-label"
                    >
                      DMSO Factor:
                    </label>
                    <div className="d-flex align-items-center">
                      <input
                        type="number"
                        className="form-control"
                        id="detection_oligo_Tm_chem_correction_parameters.DMSOfactor"
                        name="detection_oligo_Tm_chem_correction_parameters.DMSOfactor"
                        value={
                          formData.detection_oligo_Tm_chem_correction_parameters
                            .DMSOfactor.value
                        }
                  ...
                  <div className="col-md-6">
                    <label
                      htmlFor="Tm_detection_fmdfactor"
                      className="form-label"
                    >
                      Formamide Factor:
                    </label>
                    <div className="d-flex align-items-center">
                      <input
                        type="number"
                        className="form-control"
                        id="detection_oligo_Tm_chem_correction_parameters.fmdfactor"
                        name="detection_oligo_Tm_chem_correction_parameters.fmdfactor"
                        value={
                          formData.detection_oligo_Tm_chem_correction_parameters
                            .fmdfactor.value
                        }
                  ...
                  <div className="col-md-6">
                    <label
                      htmlFor="Tm_detection_fmdmethod"
                      className="form-label"
                    >
                      Formamide Method:
                    </label>
                    <div className="d-flex align-items-center">
                      <input
                        type="number"
                        className="form-control"
                        id="detection_oligo_Tm_chem_correction_parameters.fmdmethod"
                        name="detection_oligo_Tm_chem_correction_parameters.fmdmethod"
                        value={
                          formData.detection_oligo_Tm_chem_correction_parameters
                            .fmdmethod.value
                        }
                  ...
                  <div className="col-md-6">
                    <label htmlFor="Tm_detection_GC" className="form-label">
                      GC (optional):
                    </label>
                    <div className="d-flex align-items-center">
                      <input
                        type="text"
                        className="form-control"
                        id="detection_oligo_Tm_chem_correction_parameters.GC"
            ...
            <Collapse in={expanded}>
              <div className="text-center mt-2">
                <p className="text-muted">
                  Padlock probes are short single-stranded oligos designed to
                  bind a target sequence at both their 5′ and 3′ ends. Once
                  hybridized, the probe’s ends are ligated to form a circular
                  molecule that can then be amplified or visualized in situ.
                  Scrinshot (Single-Cell RNA In-Situ Hybridization and
                  Sequencing On Tissue) uses these padlock probes to detect and
                  quantify specific RNA transcripts at single-cell resolution,
                  enabling highly multiplexed and spatially resolved gene
                  expression analysis. Padlock probes contain two variable
                  gene-specific 5’- and 3’- arms and a stable backbone sequence
                  of 53 nucleotides (nt) which is subdivided in four parts.
                  Circularized padlock probe is hybridized to the complementary
          ...
          <ul className="nav nav-tabs">
            ...
            <li className="nav-item">
              <button
                type="button"
                className={`nav-link ${
                  activeTab === "detection_oligos" ? "active" : ""
                }`}
                onClick={() => {
