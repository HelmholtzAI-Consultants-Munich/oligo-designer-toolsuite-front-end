        ...
        return (
          <div>
            ...
            <div className="row g-3">
              <div className="col">
                <label htmlFor="probe_length_min" className="form-label">
                  Min Probe Length:
                </label>
                <div className="d-flex align-items-center">
                  <input
      ...
      case "readout":
        return (
          <div className="mb-4">
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.readout_probe_GC_content_min.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.readout_probe_GC_content_max.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
            ...
            <div className="mb-3">
              <label htmlFor="readout_probe_set_size" className="form-label">
              ...
              <div className="d-flex align-items-center">
                <input
                  ...
                  value={formData.readout_probe_set_size.value}
                  onChange={handleChange}
                  required
                />
                <OverlayTrigger
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={
                      formData.readout_probe_homogeneous_properties_weights.TmNN
                        .value
                    }
                    onChange={handleChange}
                    required
                    ...
                    overlay={
                      <Popover id="popover-n_jobs">
                        <Popover.Body>
                          {
                            formData
                              .readout_probe_homogeneous_properties_weights.TmNN
                              .comment
                          }
                        </Popover.Body>
                      </Popover>
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={
                      formData.readout_probe_homogeneous_properties_weights
                        .GC_content.value
                    }
                    onChange={handleChange}
                    required
            ...
            <div className="row g-3">
                  ...
                  <OverlayTrigger
                    ...
                    overlay={
                      <Popover id="popover-n-bits">
                        <Popover.Body>{formData.n_bits.comment}</Popover.Body>
                      </Popover>
                    }
                  >
                    <InfoCircle
              ...
              <div className="col">
                <label htmlFor="min_hamming_dist" className="form-label">
              ...
              <div className="col">
                <label htmlFor="hamming_weight" className="form-label">
                  Hamming Weight:
                </label>
                <div className="d-flex align-items-center">
                  <input
          ...
          <div>
            <div className="mb-4">
              ...
              <div className="row g-3">
                ...
                <div className="col">
                  <label htmlFor="primer_length" className="form-label">
                    Primer Length:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
              ...
              <div className="row g-3">
                <div className="col">
                  <label htmlFor="primer_GC_content_min" className="form-label">
                    Min GC Content:
                  </label>
                  <input
                    type="number"
                ...
                <div className="col">
                  <label htmlFor="primer_GC_content_max" className="form-label">
                    Max GC Content:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                ...
                <div className="col">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      ...
                      value={
                        formData.primer_number_three_prime_base_GCclamp.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-n_jobs">
                          <Popover.Body>
                            {
                              formData.primer_number_three_prime_base_GCclamp
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
              ...
              <div className="row g-3">
                ...
                <div className="col">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      ...
                      value={
                        formData.primer_max_len_complement_reverse_primer.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-reverse-complement">
                          <Popover.Body>
                            {
                              formData.primer_max_len_complement_reverse_primer
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col">
                  <label htmlFor="primer_Tm_min" className="form-label">
                    Min Primer Tm (°C):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                ...
                <div className="col">
                  <label htmlFor="primer_Tm_max" className="form-label">
                    Max Primer Tm (°C):
                  </label>
                  <div className="d-flex align-items-center">
                    <input
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={
                      formData.primer_secondary_structures_threshold_deltaG
                        .value
                    }
                    onChange={handleChange}
                  />
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-nn-table-detection">
                          <Popover.Body>
                            {
                              formData.target_probe_Tm_parameters.nn_table
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      ...
                      value={
                        formData.target_probe_Tm_parameters.tmm_table.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      ...
                      value={
                        formData.target_probe_Tm_parameters.imm_table.value
                      }
                      onChange={handleChange}
                    />
                    <OverlayTrigger
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-de-table-detection">
                          <Popover.Body>
                            {
                              formData.target_probe_Tm_parameters.de_table
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                    ...
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-saltcorr-detection">
                          <Popover.Body>
                            {
                              formData.target_probe_Tm_parameters.saltcorr
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
          ...
          <div>
            <div className="mb-4">
              <div className="row g-3">
                <div className="col">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      ...
                      value={formData.readout_probe_initial_num_sequences.value}
                      onChange={handleChange}
                      required
                    />
                    <OverlayTrigger
                      ...
                      overlay={
                        <Popover id="popover-initial-sequences">
                          <Popover.Body>
                            {
                              formData.readout_probe_initial_num_sequences
                                .comment
                            }
                          </Popover.Body>
                        </Popover>
                ...
                <div className="col">
                  <label htmlFor="perc_identity" className="form-label">
                    Percentage Identity:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
              ...
              <div className="row g-3">
                ...
                <div className="col">
                  <label htmlFor="word_size" className="form-label">
                    Word Size:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
              ...
              <div className="row g-3">
                <div className="col">
                  <label htmlFor="max_target_seqs" className="form-label">
                    Max Target Sequences:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
                ...
                <div className="col">
                  <label htmlFor="max_hsps" className="form-label">
                    Max HSPs:
                  </label>
                  <div className="d-flex align-items-center">
                    <input
              ...
              <div>
                ...
                <div className="mb-3">
                  <label htmlFor="min_alignment_length" className="form-label">
                  ...
                  <div className="d-flex align-items-center">
                    <input
                      ...
                      value={
                        formData.readout_probe_specificity_blastn_hit_parameters
                          .min_alignment_length.value
                      }
                      onChange={handleChange}
                      required
        ...
        return (
          <div>
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={formData.primer_initial_num_sequences.value}
                    onChange={handleChange}
                    required
                  />
                  <OverlayTrigger
              ...
              <div className="col">
                ...
                <div className="d-flex align-items-center">
                  <input
                    ...
                    value={
                      formData.primer_specificity_refrence_blastn_hit_parameters
                        .min_alignment_length.value
                    }
                    onChange={handleChange}
                    required
            ...
            <div className="row g-3">
              ...
              <div className="col">
                <label htmlFor="nn_table" className="form-label">
                  NN Table:
                </label>
                <div className="d-flex align-items-center">
                  <input
            ...
            <div className="row g-3">
              <div className="col">
                <label htmlFor="tmm_table" className="form-label">
                  TMM Table:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="imm_table" className="form-label">
                  IMM Table:
                </label>
                <div className="d-flex align-items-center">
                  <input
              ...
              <div className="col">
                <label htmlFor="de_table" className="form-label">
                  DE Table:
                </label>
                <div className="d-flex align-items-center">
                  <input
            ...
            <div className=" row g-3">
              <div className="col">
                <label htmlFor="saltcorr" className="form-label">
