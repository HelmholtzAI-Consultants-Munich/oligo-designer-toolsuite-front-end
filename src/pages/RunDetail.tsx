...
const RunDetail = () => {
    ...
    const actions = useMemo(() => {
        ...
        const basicActions = [useSettingsAction, deleteAction];

        if (probes) {
            if (!fileActions) return basicActions;

            return [useSettingsAction, ...fileActions, deleteAction];
        } else {
            return basicActions;
        }
    }, [run, probes, handleDelete, handleUseSettings, fileActions]);
