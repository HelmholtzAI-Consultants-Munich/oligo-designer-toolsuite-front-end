const formDatas = {
    ...
    dir_output: {
        value: "output_scrinshot_probe_designer",
    ...
    file_regions: {
        value: "data/genes/custom_3.txt",
        comment:
            "file with a list the genes used to generate the oligos sequences, leave empty if all the genes are used",
    },
    files_fasta_target_probe_database: {
        value: [
            "data/genomic_regions/exon_annotation_source-NCBI_species-Homo_sapiens_annotation_release-110_genome_assemly-GRCh38.fna, data/genomic_regions/exon_exon_junction_annotation_source-NCBI_species-Homo_sapiens_annotation_release-110_genome_assemly-GRCh38.fna",
        ],
        comment:
    ...
    target_probe_padlock_arm_Tm_dif_max: {
        value: "2",
        comment:
            "maximum melting temperature difference of both arms (difference shouldn't be higher than 5! But range is not super important, the lower the better)",
    },
    target_probe_padlock_arm_length_min: {
        value: "10",
        comment: "minimum length of each arm",
    },
    target_probe_padlock_arm_Tm_min: {
        value: "50",
        comment: "minimum melting temperature of each arm",
    },
    target_probe_padlock_arm_Tm_max: {
        value: "60",
        comment: "maximum melting temperature of each arm",
    },
    ...
    target_probe_isoform_weight: {
        value: "2",
        comment:
            "weight of the isoform consensus of the probe in the efficiency score",
    },
    ...
    detection_oligo_min_thymines: {
        value: "2",
        comment: "minimal number of Thymines in detection oligo.",
    },
    detection_oligo_length_min: {
        value: "15",
        comment: "minimum length of detection probe",
    },
    detection_oligo_length_max: {
        value: "40",
        comment: "maximum length of detection probe",
    },
    detection_oligo_U_distance: {
        value: "5",
        comment: "preferred minimal distance between U(racils)",
    },
    detection_oligo_Tm_opt: {
        value: "56",
        comment: "optimal melting temperature of detection probe",
    },
    ...
    target_probe_specificity_blastn_hit_parameters: {
        coverage: {
            value: "50",
            comment: "can be turned into min_alignment_length",
        },
    },
