const formDatas = {
    ...
    dir_output: {
        value: "output_oligo_seq_probe_designer",
        comment: "name of the directory where the output files will be written",
    },
    write_intermediate_steps: {
        value: "true",
        comment: "if true, saves intermediate results after each step",
    },
    top_n_sets: {
        value: "3",
        comment:
    ...
    files_fasta_target_probe_database: {
        ...
        comment:
            "fasta file with sequences form which the oligos should be generated. Hint: use the genomic_region_generator pipeline to create fasta files of genomic regions of interest",
    },
    ...
    target_probe_isoform_consensus: {
        value: "0",
        comment:
            "min isoform consesnsus for oligos, i.e. how many transcripts of the total number of transcripts of a gene are covered by the oligo, given in %",
    },
    ...
    target_probe_secondary_structures_T: {
        value: "37",
        comment: "temperature to compute the secondary structure free energy",
    },
    ...
    target_probe_max_len_selfcomplement: {
        value: "10",
        comment:
            "The maximum length of self-complementary sequence allowed to avoid homodimer formation.",
    },
    target_probe_hybridization_probability_threshold: {
        value: "0.001",
        comment: "the lower the threshold the more stringent the filter",
    },
    ...
    set_size_min: {
        value: "3",
        comment:
            "minimum size of oligo sets (in case there exist no set of the optimal size) -> genes with less oligos will be filtered out and stored in regions_with_insufficient_oligos_for_db_probes",
    },
    ...
    target_probe_hybridization_probability_blastn_hit_parameters: {
        coverage: {
            value: "50",
            comment: "could be turned into min_alignment_length",
        },
    },
    target_probe_hybridization_probability_bowtie_search_parameters: {
        ...
        nofw: {
            value: "",
            comment:
                "this parameter is fixed, if reference is whole genome, consider using both strands (remove this parameter)",
        },
    },
    target_probe_hybridization_probability_bowtie_hit_parameters: {
        value: "None",
        comment: "No hit parameters available currently",
    },
