...
This folder contains example annotations from NCBI release 110 for _H.Sapiens_ and Ensembl release 108 for _H.Sapiens_. It includes BED, fasta, GTF and GFF example files, filtered for chromosome 16 with:
