...
This folder contains example annotations from NCBI release 110 for _H.Sapiens_. For all annotation the RefSeq-Accn was replaced with chromsome names or GenBank-Accn (e.g. from NC_000016.10 to 16). It includes FASTA, GTF and VCF example files, filtered for chromosome 16 with:
